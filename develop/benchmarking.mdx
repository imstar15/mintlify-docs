---
title: 'Benchmarking'
description: 'This document covers the benchmarking, the performance testing procedure for pallet development'
---
...
1. __Write a benchmarking.rs for pallet__
	...
	![benchmarks](/images/develop/benchmarking/benchmarks.png)
	...
	![schedule_round](/images/develop/benchmarking/schedule_round.png)
	...
	![project_indexs](/images/develop/benchmarking/project_indexs.png)
...
1. __Configure the benchmarking CLI__
	...
	![dependencies](/images/develop/benchmarking/dependencies.png)

	3.2 Configure pallet benchmarking in runtime
	
	3.2.1. Include runtime-benchmarking features in cargo.toml

	![runtime-benchmarks](/images/develop/benchmarking/runtime-benchmarks.png)

	3.2.2. Configure pallet benchmarking in runtime.rs

	![add_benchmark](/images/develop/benchmarking/add_benchmark.png)
...
1. __Add a weight tag to the function of the pallet__
	...
	![tag](/images/develop/benchmarking/tag.png)
